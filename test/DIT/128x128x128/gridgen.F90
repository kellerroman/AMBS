...
write(*,'(A)') "GRID GEN for 128^3 DIT"
i = 1
DO
...
ibc(2,2,1)  = jmax - 1
ibc(3,2,1)  = kmax - 1
call cg_boco_write_f(cgns_file,cgns_base,cgns_zone,'WEST',BCSymmetryPlane,PointRange,2,ibc(:,:,1),cgns_bc,ierror)
...
ibc(2,2,2)  = jmax - 1
ibc(3,2,2)  = kmax - 1
call cg_boco_write_f(cgns_file,cgns_base,cgns_zone,'EAST',BCSymmetryPlane,PointRange,2,ibc(:,:,2),cgns_bc,ierror)
